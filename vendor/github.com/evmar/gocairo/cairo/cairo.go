...
func (pi *PathIter) Next() *PathSegment {
	...
	// things complicated.
	dataArray := (*[1 << 20]C.cairo_path_data_t)(unsafe.Pointer(pi.path.Ptr.data))
...
func SVGGetVersions() []SVGVersion {
	...
	slice := (*[1 << 20]C.cairo_svg_version_t)(unsafe.Pointer(cVersionsPtr))[:cNumVersions:cNumVersions]
